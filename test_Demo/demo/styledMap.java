 ...
 */
public class styledMap extends MapView {

    public styledMap(MapViewOptions optionsMapV) {
    	super(optionsMapV);
    ...
    public static void main(String[] args) {
        ...
        mapOptions.setApiKey("AIzaSyBtefj5xL2e6j-qt65FaXdevjKB3oErQjo");
    	
    	final styledMap mapView = new styledMap(mapOptions);
