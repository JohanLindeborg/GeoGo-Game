...
public class Instructions extends JPanel {
	...
	public Instructions() {
		...
		setLayout(null); // S�tter min JPanel till null, overriding BouderLayout
...
//				
		...
		wrapArea = new JTextArea(text+ text2+ text3, bounds.width - 200, bounds.height - 200);// S�tter texten p� en
																							// JtextArea
		wrapArea.setBounds(0, 0, bounds.width - 300, bounds.height - 200);// s�tter position p� texten
		this.font = new Font(text, Font.BOLD, 14);
		this.font2 = new Font(text2, Font.PLAIN, 8);
		this.font3 = new Font(text3, Font.PLAIN, 14);


		textLbl.add(wrapArea);// S�tter JTextArea p� JLabel
